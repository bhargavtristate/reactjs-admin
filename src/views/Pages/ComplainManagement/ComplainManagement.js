...
class Categories extends Component {
  constructor(props) {
    ...
    else
    {
      ...
      this.state = {complain: [],activePage: 1,paginationData:10,totalRecords:0,admin_info:admin_info,access_data:access_data};
      this.getComplains = this.getCategories.bind(this);
      this.getCategories();
