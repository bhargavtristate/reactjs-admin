...
class Tasker extends Component {
  constructor(props) {
    ...
    else
    {
      ...
      var manage_access=commonMethods.checkCurrentUriAccess('tasker_update');
    }
    this.st
    this.state = {taskers: [],activePage: 1,paginationData:10,totalRecords:0,searchText:'',management:manage_access};
    this.getTaskers = this.getTaskers.bind(this);
    this.getTaskers();
          ...
          <div className="col-lg-12">
            <div className="card">
              <div className="card-header">
                <i className="fa fa-align-justify"></i> Taskers
              </div>
              <div className="row">
                ...
                <div className="search-box col-md-4 mt-4">
                  <div className="input-group">
                    ...
                    <span className="input-group-btn"><button type="button" className="btn btn-primary" onClick={this.getTaskers.bind(this,this.state)}>Search</button></span>
                  </div>
                </div>
              </div>
              <div className="card-block">
                <table className="table table-bordered table-striped table-sm">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th onClick={this.getTaskers.bind(this,'first_name')} className="haveSorting">First Name <i className="fa fa-sort"></i></th>
                      <th onClick={this.getTaskers.bind(this,'last_name')} className="haveSorting">Last Name <i className="fa fa-sort"></i></th>
                      <th>Username</th>
                      <th>Speciality</th>
                      <th>Email</th>
                      <th>Phone Number</th>
   ...
   render() {
      return (
         <tr>
            ...
            {this.props.data.speciality==null && 
             <td>N/A</td>}
            {this.props.data.speciality!=null && 
              <td>{this.props.data.speciality.category_name_english}</td>}
            <td>{this.props.data.email}</td>
            <td>{this.props.data.phone_no}</td>
            <td>{this.props.data.account_no}</td>
            ...
            <td>{this.props.data.credit_point}</td>
            { this.props.stateData.management!=0 &&
            <td>
            <Link to={'/tasker_update?_id='+this.props.data._id} className="btn btn-sm btn-primary mr-2" activeClassName="active"><i className="fa fa-edit"></i> Edit </Link>
